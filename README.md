...
- 💻 **GitHub Repository:** [View Source Code](YOUR_GITHUB_LINK)
- 📓 **Training Notebook:** [Open Colab Notebook](YOUR_COLAB_LINK)
- 📝 **Blog / Writeup:** [Read the Blog](YOUR_BLOG_LINK)
- 🎥 **Short Demo Video:** [Watch the Video](YOUR_VIDEO_LINK)

⚠️ **Judges should use the Hugging Face Space URL as the main environment URL.**
